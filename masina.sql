...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 09, 2018 at 03:52 PM
...
(1, 1, '127.0.0.1', '2018-02-09 14:49:11', '2018-02-09 14:49:11');
...
(1, 'Vasilije', 'Milenkovic', 'vasilie', 'vasilie.91@gmail.com', '$2y$10$fr0WiFX5EgE5GMdaSG7/AezQ3Fxgx5HouQpyTQgSepzQkAe4BC84m', NULL, '$2y$10$PC9eHClC8CgYcQLH8u0Zv.nUXyQYlIj5V.Ppm5IsOGFMcTohhNsAO', NULL, '', 1, 2, NULL, '2018-02-09 14:49:11', '2018-02-09 14:49:00', '2018-02-09 14:49:11', 1);
...
(1, 'Owners', '2018-02-09 14:48:59', '2018-02-09 14:48:59', 'owners', 'Default group for website owners.', 0);
...
(1, 'Publisher', 'publisher', 'Site editor with access to publishing tools.', '', 1, '2018-02-09 14:48:59', '2018-02-09 14:48:59'),
(2, 'Developer', 'developer', 'Site administrator with access to developer tools.', '', 1, '2018-02-09 14:48:59', '2018-02-09 14:48:59');
...
(4, 'system', 'update', 'retry', '1518277752');
...
(1, 'October.Demo', 'comment', '1.0.1', 'First version of Demo', '2018-02-09 14:48:59'),
(2, 'RainLab.Builder', 'comment', '1.0.1', 'Initialize plugin.', '2018-02-09 14:49:48'),
(3, 'RainLab.Builder', 'comment', '1.0.2', 'Fixes the problem with selecting a plugin. Minor localization corrections. Configuration files in the list and form behaviors are now autocomplete.', '2018-02-09 14:49:48'),
(4, 'RainLab.Builder', 'comment', '1.0.3', 'Improved handling of the enum data type.', '2018-02-09 14:49:48'),
(5, 'RainLab.Builder', 'comment', '1.0.4', 'Added user permissions to work with the Builder.', '2018-02-09 14:49:48'),
(6, 'RainLab.Builder', 'comment', '1.0.5', 'Fixed permissions registration.', '2018-02-09 14:49:48'),
(7, 'RainLab.Builder', 'comment', '1.0.6', 'Fixed front-end record ordering in the Record List component.', '2018-02-09 14:49:48'),
(8, 'RainLab.Builder', 'comment', '1.0.7', 'Builder settings are now protected with user permissions. The database table column list is scrollable now. Minor code cleanup.', '2018-02-09 14:49:48'),
(9, 'RainLab.Builder', 'comment', '1.0.8', 'Added the Reorder Controller behavior.', '2018-02-09 14:49:48'),
(10, 'RainLab.Builder', 'comment', '1.0.9', 'Minor API and UI updates.', '2018-02-09 14:49:48'),
(11, 'RainLab.Builder', 'comment', '1.0.10', 'Minor styling update.', '2018-02-09 14:49:48'),
(12, 'RainLab.Builder', 'comment', '1.0.11', 'Fixed a bug where clicking placeholder in a repeater would open Inspector. Fixed a problem with saving forms with repeaters in tabs. Minor style fix.', '2018-02-09 14:49:48'),
(13, 'RainLab.Builder', 'comment', '1.0.12', 'Added support for the Trigger property to the Media Finder widget configuration. Names of form fields and list columns definition files can now contain underscores.', '2018-02-09 14:49:48'),
(14, 'RainLab.Builder', 'comment', '1.0.13', 'Minor styling fix on the database editor.', '2018-02-09 14:49:48'),
(15, 'RainLab.Builder', 'comment', '1.0.14', 'Added support for published_at timestamp field', '2018-02-09 14:49:48'),
(16, 'RainLab.Builder', 'comment', '1.0.15', 'Fixed a bug where saving a localization string in Inspector could cause a JavaScript error. Added support for Timestamps and Soft Deleting for new models.', '2018-02-09 14:49:48'),
(17, 'RainLab.Builder', 'comment', '1.0.16', 'Fixed a bug when saving a form with the Repeater widget in a tab could create invalid fields in the form''s outside area. Added a check that prevents creating localization strings inside other existing strings.', '2018-02-09 14:49:48'),
(18, 'RainLab.Builder', 'comment', '1.0.17', 'Added support Trigger attribute support for RecordFinder and Repeater form widgets.', '2018-02-09 14:49:48'),
(19, 'RainLab.Builder', 'comment', '1.0.18', 'Fixes a bug where ''::class'' notations in a model class definition could prevent the model from appearing in the Builder model list. Added emptyOption property support to the dropdown form control.', '2018-02-09 14:49:48'),
(20, 'RainLab.Builder', 'comment', '1.0.19', 'Added a feature allowing to add all database columns to a list definition. Added max length validation for database table and column names.', '2018-02-09 14:49:48'),
(21, 'RainLab.Builder', 'comment', '1.0.20', 'Fixes a bug where form the builder could trigger the "current.hasAttribute is not a function" error.', '2018-02-09 14:49:48'),
(22, 'RainLab.Builder', 'comment', '1.0.21', 'Back-end navigation sort order updated.', '2018-02-09 14:49:48');
...
(1, 'October.Demo', '1.0.1', '2018-02-09 14:48:59', 0, 0),
(2, 'RainLab.Builder', '1.0.21', '2018-02-09 14:49:48', 0, 0);
